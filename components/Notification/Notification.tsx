...
const Notification: React.FC<NotificationProps> = ({ isVisible, onClose, containerClasses }) => {
  ...
  return (
    isVisible && (
      <div
        className={`w-[450px] h-[600px] bg-[#192943] ${containerClasses} z-[100] shadow-[1px_1px_5px_5px_#00000036] rounded-lg transition-[10]`}
        ref={ref}
      >
        ...
        <div className="px-8 py-4 flex flex-col gap-4">
          <div className="rounded-lg bg-[#213759] flex px-10 justify-between items-center py-2">
            <button className="bg-[#192943] rounded px-2 py-1 text-white text-[14px]">
              View All
            </button>
            <button className="bg-[#192943] rounded px-2 py-1 text-white text-[14px]">
              Verified
